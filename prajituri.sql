DROP TYPE IF EXISTS categ_prajitura; --stergem tipurile de date create anterior
...
CREATE TABLE IF NOT EXISTS prajituri (
   ...
   descriere TEXT, -- text e mai bun decat varchar pentru ca nu are limita de caractere
   pret NUMERIC(8,2) NOT NULL,
   gramaj INT NOT NULL CHECK (gramaj>=0),   
   tip_produs tipuri_produse DEFAULT 'cofetarie',
   calorii INT NOT NULL CHECK (calorii>=0), --- calorii negative nu au sens
